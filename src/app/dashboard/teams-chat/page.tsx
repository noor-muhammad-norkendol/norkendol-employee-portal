...
type ProviderKey = "ms-teams" | "google-chat";
...
const PROVIDERS: Provider[] = [
  {
    ...
    description: "Opens recent chats in a new tab",
    href: "https://teams.cloud.microsoft/v2/?clientexperience=t2#/chat/0/0",
    token: "--info",
    icon: (
  ...
  },
  {
    key: "google-chat",
    label: "Google Chat",
    description: "Opens Google Workspace chat in a new tab",
...
const STORAGE_KEY = "portal-teams-chat-provider";
const PAGE_TITLE_PRIMARY = "Teams";
const PAGE_TITLE_SECONDARY = "Chat";

export default function TeamsChatPage() {
  // null = not yet read; "" = read & no preference; key = saved preference
  ...
  // If preference set, auto-launch in a new tab once the value is read
  useEffect(() => {
    if (!pref) return;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-3 text-sm" style={{ color: "var(--text-dim)" }}>
          Pick your team chat platform. Your choice is saved — next time you open this page it&rsquo;ll launch automatically.
        </p>
      </div>
...
/* ── auto-launch landing (saved preference) ── */
