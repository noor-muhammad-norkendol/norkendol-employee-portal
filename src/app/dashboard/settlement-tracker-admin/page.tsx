...
export default function SettlementTrackerAdminPage() {
  ...
  // Admin page — always treat as admin (page is role-gated by sidebar tier 2A)
  const isAdmin = true;
    ...
    return (
      <div className="p-6 max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold mb-2" style={{ color: "var(--text-primary)" }}>
          Settlement Tracker Admin
        </h1>
        <p className="text-sm mb-8" style={{ color: "var(--text-secondary)" }}>
          Full management view — all files, CRUD, analytics, and exports.
        </p>
